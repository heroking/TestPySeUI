...
# DC_PATH = BASE_DIR  + "\\data\\districtcode.txt"
DC_PATH = globalparam.data_path + "\\districtcode.txt"
...
class Person(object):
    def __init__(self):
        ...
        self.front_numbers = ["130","131","132","133","134","135","136","137","138","139","147","150","151","152","153","155",
    ...
    def full_name(self):
        _last = self.last_name(1, self.last_names)
        return "{}{}".format(_last, self.first_name(random.randint(1, 2), _last, self.first_names))
    
    # 随机生成手机号码
    def random_phonenumber(self):
        return random.choice(self.front_numbers)+"".join(random.choice("0123456789") for i in range(8))

    # 随机获取区域代码
    def __get_districtcode(self): 
    ...
    def random_id(self): 
        ...
        codelist = [] 
        if not codelist:
            self.__get_districtcode()
        cid = codelist[random.randint(0,len(codelist))]['code'] #地区项 
        cid = cid + str(random.randint(1957,2000)) #年份项 
        da = date.today()+timedelta(days=random.randint(1,366)) #月份和日期项 
        cid = cid + da.strftime('%m%d') 
        cid = cid+ str(random.randint(100,300))#，顺序号简单处理 
...
#         print u"cid:",cid
        ...
        for i in range(0,len(cid)): 
            count = count +int(cid[i])*weight[i] 
        cid = cid + checkcode[count%11] #算出校验码 
        return cid

if __name__=='__main__':
    person = Person()
    print(person.full_name())
    print(person.random_phonenumber())
    print(person.random_id())
